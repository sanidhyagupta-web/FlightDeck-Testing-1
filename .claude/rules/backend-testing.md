---
paths:
  - "backend/**/test/**/*" # No backend code exists in this repository yet. Scoped under backend/ (rather than repo-wide "**/test/**/*") so it won't fire on frontend test directories once a frontend is added.
---
