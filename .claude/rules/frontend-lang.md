---
paths:
  - "frontend/**/*.ts"  # No frontend code/directory exists in this repository yet — no package.json or source tree of any kind is present. Placeholder scoped to a future frontend/ directory so this rule stays dormant rather than firing on any .ts/.tsx file anywhere in the repo (including a future backend, if it happened to be TypeScript).
  - "frontend/**/*.tsx"
---
