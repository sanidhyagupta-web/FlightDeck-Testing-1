...
**No backend, frontend, build file, or CI config exists in this repository yet** — there are no real verification commands to bind Steps 4–6 to. They're left in generic form below; fill them in once actual services/apps and their tooling exist.
